    ...
    4: {
        ...
        pages: {
            1: {
                ...
                content: [
                    {
                        component: "Text",
                        data: {
                            text: 'Наша компания была у истоков национальной инициативы и маркировки <span>«Зеленый эталон»</span>, показывающей, что удобрения отвечают всем требованиям по безопасности и обеспечивают производство высококачественной сельхозпродукции. ',
                        },
                    },
                    {
                        component: "Text",
                        data: {
                            text: 'Помимо этого, продукция Компании успешно прошла сертификацию в рамках добровольной системы <span>«Листок жизни»</span>. Также у ФосАгро есть экологическое заявление <span>«Зеленый колос»</span>, которое подтверждает, что в составе продукции не содержится опасных для здоровья человека или почв концентраций кадмия.',
                        },
                    },
                ],
                media: {
                ...
                links: [
                    { id: 1, text: "Экопреимущества", url: "https://www.phosagro.ru/production/eco/" }
                ]
            },
            2: {
