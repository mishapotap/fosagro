                ...
                content: [
                    {
                        component: "Text",
                        data: {
                            text: 'Наша компания была у истоков национальной инициативы <span>"Зеленый стандарт"</span> - маркировки, показывающей, что удобрения отвечают всем требованиям по безопасности и обеспечивают производство высококачественной сельхозпродукции.',
                        },
                    },
                ],
                media: {
