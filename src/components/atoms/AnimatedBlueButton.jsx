...
export default function AnimatedBlueButton({children, rotate = 0, size, onClick, className, background = COLORS.blue, color = COLORS.white}) {
    return (
        <Container className={className} background={background} hover={color} size={size} onClick={onClick}>
        <Circle rotate={rotate} color={color}>
