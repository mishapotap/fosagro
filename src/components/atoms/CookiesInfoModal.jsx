...
const ruText = {
    ...
    text11: "Чтобы удалить файл «cookies», воспользуйтесь кнопкой ниже. Обращаем ваше внимание на то, что прогресс прохождения курса будет полностью потерян.",
    title2: "Как удалить",
    title2Accent: "«cookies»",
